...
public class ProductSpecs {
	...
	//	ProductPricing gaming= new ProductPricing("Gaming", 70000, 10, 4,4);
		...
		return flipkartwarrentyy(total);
	...
	public static int ajiowarrenty(int total) {
		...
		while (b) {
			...
			case "streaming movie":
				...
				if (movie.equals("yes")) {
					System.out.println("Thanks for purchasing your Total purchase value is:50000 ");
				} else {
					System.out.println("Thanks for visiting your products");
			...
			case "rented movies":
				...
				if (movie2.equals("yes")) {
					System.out.println("Thanks for purchasing your Total purchase value is ");
				} else {
					System.out.println("Thanks for visiting your products");
			...
			case "dolby home driver":
				...
				if (movie3.equals("yes")) {
					System.out.println("Thanks for purchasing your Total purchase value is:54000 ");
				} else {
					System.out.println("Thanks for visiting your products");
